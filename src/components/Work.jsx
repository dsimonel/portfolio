...
import mymusic from "../assets/mymusic.jpg";
      ...
      <div className="max-w-[1200px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <WorkItem
            ...
            firstButton={t("code")}
            secondButton={"Website"}
            href1={"https://github.com/dsimonel/web3_coinmarketcap_react"}
          ...
          <WorkItem
            ...
            firstButton={"Demo"}
            secondButton={"Website"}
            href1={"http://tashipedeb.ueuo.com/index.php"}
          ...
          <WorkItem
            ...
            href2={"https://dsimonel.github.io/mybooking-ui-react/"}
          />
        </div>
      </div>
    </div>
